...
kafka_server = '192.168.50.133:9092'
topic = 'rover-hsml-data'
client_id = 'isaac-sim-producer'

# JSON file path
json_file_path = os.path.join(os.path.expanduser("~"), "Desktop", "kafkaUnreal.json")
